  ...
  return (
    ...
    >
      ...
      <div className="mt-3 text-center transition-opacity duration-300 opacity-70 group-hover:opacity-100">
        <p className="font-serif-cn text-xs text-foreground">{category.teaTypeCn}</p>
        <p className="text-[10px] text-muted-foreground tracking-wider mt-0.5">{category.label}</p>
      </div>
    </div>
  );
};
